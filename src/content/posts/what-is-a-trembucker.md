...
id: 5109
type: "post"
wpSlug: "what-is-a-trembucker"
path: "/what-is-a-trembucker/"
url: "https://www.electrikjam.com/what-is-a-trembucker/"
title: "What Is A Trembucker? Don’t Worry, We Didn’t Know Either!"
excerpt: "<p>I had seen the question come up on several forums before. &#8220;What is a Trembucker?&#8221; in regards to a Seymour Duncan Pickup model. I did not really know the answer until now! If you have ever been interested in buying some aftermarket pickups, you will notice that there are tons of options out there. There [&hellip;]</p>\n"
date: "2021-10-20T13:04:44+00:00"
modified: "2024-10-04T09:08:37+00:00"
...
seo: 
  title: "What Is A Trembucker? Don't Worry, We Didn't Know Either!"
  description: "I had seen the question come up on several forums before. \"What is a Trembucker?\" in regards to a Seymour Duncan Pickup model. Today, we learn why!"
  canonical: "https://www.electrikjam.com/what-is-a-trembucker/"
---


<p><strong>I had seen the question come up on several forums before. &#8220;What is a Trembucker?&#8221; in regards to a Seymour Duncan Pickup model. I did not really know the answer until now!</strong></p>
...
<p>When buying new pickups, you always want to check which<em> kind </em>you need. If the slot is for a single coil, you will need to buy something that will fit that route. The same goes for humbuckers. You should always measure your guitar&#8217;s routing, and then measure it against the size of the replacement pickup. Most pickup manufacturers have the exact dimensions for each pickup on the <a href="https://www.seymourduncan.com/" target="_blank" rel="noopener noreferrer nofollow" data-lasso-id="11084"><strong>official websites.</strong></a></p>



<p>Somehow, I was mostly oblivious to the idea of &#8220;F-Spaced&#8221; or the term &#8220;Trembucker&#8221;. We will get into the reasons why I did not notice that this was a big deal, but as it turns out, it definitely can be! Today we will answer &#8220;What is a Trembucker?&#8221; and take a look at why it may or <em>may not</em> matter to you as a guitarist.</p>
...
<h2 class="wp-block-heading">What Is A Trembucker?</h2>
...
<p>It should be noted that there are a few exceptions to this rule. Something like active pickups, have a large bar magnet instead of individual pole pieces and bobbins. So you do not need to worry about spacing when it comes to active pickups. All active pickups work the same whether in a fixed bridge, or a Floyd Rose.</p>
...
<p>There is the argument that most pickups have a strong magnetic field and that strings lining up perfectly with the pole pieces of a pickup doesn&#8217;t really mean much. Since pickups are essentially the &#8220;microphone&#8221; for your guitar strings, I can see the point in this argument. But if you are slightly OCD about aesthetics&#8230;you probably want the strings to line up with the pickups perfectly.</p>
...
<p>We don&#8217;t really know if this has an effect on tone as much as it<em> seems</em>. Eddie certainly had some killer sounds on the first <strong>Van Halen </strong>albums. So in some regards, I am not sure that a Trembucker really matters when it comes to <em>tone</em>. But it definitely matters when it comes to <em>aesthetics</em>.</p>
...
<h2 class="wp-block-heading">What Is A Trembucker: Wrapping Up&#8230;</h2>
...
<p>I am also not 100% convinced that Trembucker spacing makes any real impact on tone. It certainly <em>looks </em>better. But as far as the pickup producing an accurate sound, I do not think something as small as bridge spacing is going to make or break your tone.</p>



<p>Everyone is different when it comes to guitar gear preferences, so the choice is really up to you!</p>
